...
#' }
#' @seealso \code{\link{loadMetaData}} To display gloabl informations about the experiment. 
#' @export
loadROIsFromFile <- function(FILE, rois = NULL, min_time = 0, max_time = Inf, relative_distances = TRUE){
	time_in_seconds <- T
...
#' 
#' This function is used to obtain meta data -- such as data of the experiment, aquisition device, ...--

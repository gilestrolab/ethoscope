...
class mAGOSleepRestriction(mAGO):
    ...
    _description = {
        ...
        "arguments": [
            ...
            },
            {
                ...
                "description": "Minimal time after which inactive animal is stimulated (s)",
                "default": 120,
            },
            {
                "type": "number",
                ...
                "step": 50,
                "name": "pulse_duration",
                "description": "Duration of stimulus delivery (ms)",
                "default": 1000,
            },
            {
                "type": "number",
    ...
    def __init__(
        ...
        try:
            ...
            logging.info(
                f"mAGOSleepRestriction initialized: {daily_duration_hours}h/{interval_hours}h "
    ...
    def bind_tracker(self, tracker):
        ...
        if tracker and hasattr(tracker, "_roi") and tracker._roi:
            ...
            self._state_file_path = os.path.join(
                self._state_dir, f"sleep_restriction_roi_{roi_id}.json"
            )
            ...
            logging.info(
                f"Sleep restriction state file set for ROI {roi_id}: {self._state_file_path}"
            )
    ...
    def get_schedule_status(self):
        ...
        if not overall_active:
            ...
            status["status"] = (
                f"Waiting for next active period in {next_period_hours:.1f} hours"
            )
        else:
    ...
    _description = {
        ...
        "arguments": [
            ...
            # Preset patterns
            {
                ...
                "description": "1=8h/day, 2=12h/day, 3=6h twice/day, 4=4h three times/day, 5=custom",
                "default": 1,
            },
            {
                "type": "time",
            ...
            # Custom pattern (only used if restriction_pattern=5)
            {
                ...
                "description": "Custom hours active per day (pattern 5 only)",
                "default": 8,
            },
            {
                "type": "number",
                ...
                "description": "Custom hours between periods (pattern 5 only)",
                "default": 24,
            },
            {
                "type": "date_range",
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if restriction_pattern not in self._PATTERNS:
            raise ValueError(
                f"Invalid restriction_pattern: {restriction_pattern}. Must be 1-5."
            )

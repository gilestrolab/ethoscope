...
from ethoscope_node.scanner.ethoscope_scanner import EthoscopeScanner, Ethoscope
...
class TestInvalidDeviceFiltering:
    ...
    def setup_method(self):
        ...
        with patch('ethoscope_node.scanner.ethoscope_scanner.ExperimentalDB') as mock_edb_class:
            mock_edb_class.return_value = self.mock_edb
            self.scanner = EthoscopeScanner(
                device_refresh_period=1,

...
class TestEmailNotificationService:
    ...
    def test_create_email_message_basic(self, email_service):
        ...
        msg = email_service._create_email_message(
            to_emails, subject, html_body, text_body
        )
    ...
    def test_create_email_message_with_attachments(self, email_service):
        ...
        msg = email_service._create_email_message(
            to_emails, subject, html_body, text_body, attachments
        )
    ...
    @patch.object(EmailNotificationService, "get_admin_emails")
    def test_send_device_stopped_alert_no_recipients(
        self, mock_get_admin, mock_get_users, email_service
    ):
    ...
    def test_send_storage_warning_alert_success(
        self, mock_get_admin, mock_get_users, mock_send, email_service
    ):
    ...
    def test_send_device_unreachable_alert_success(
        self, mock_get_admin, mock_send, email_service
    ):
    ...
    @patch.object(EmailNotificationService, "_send_email")
    @patch.object(EmailNotificationService, "get_admin_emails")
    def test_test_email_configuration_success(
        self, mock_get_admin, mock_send, email_service
    ):
    ...
    @patch.object(EmailNotificationService, "_send_email")
    @patch.object(EmailNotificationService, "get_admin_emails")
    def test_test_email_configuration_exception(
        self, mock_get_admin, mock_send, email_service
    ):
    ...
    @patch.object(EmailNotificationService, "get_device_logs")
    @patch.object(EmailNotificationService, "analyze_device_failure")
    def test_send_device_stopped_alert_without_logs(
        self, mock_analyze, mock_get_logs, email_service
    ):

...
class TestNotificationRecipientScenarios:
    ...
    def test_storage_warning_recipients(self, test_db):
        ...
        device_users = test_db.getUsersForDevice('device_001', running_only=True, asdict=True)
    ...
    def test_no_recipients_when_no_running_experiments(self, test_db):
        ...
        device_users = test_db.getUsersForDevice('device_002', running_only=True, asdict=True)

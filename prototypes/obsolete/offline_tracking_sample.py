...
l = []; input_video_list = open("/home/gg/OLFACTOVIDEOS/file_list.txt")
for input_video_file in input_video_list: l.append(input_video_file)

for input_video in l[6:]:
    ...
    rdw = rawdatawriter(basename = input_video + ".npy", n_rois=len(rois), entities=entities)
    #rdw = None
